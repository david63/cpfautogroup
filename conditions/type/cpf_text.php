...
class cpf_text extends base
{
	...
	*/
	...
	{
		return 'david63.cpfautogroup.autogroups.type.cpf_text';
	}
	...
	*/
	...
	{
		$cpf_field = 'pf_' . $this->functions->cpf_data_get('cpf_field_name', 'text');
			return $cpf_field;
		}
	...
	*/
	...
	{
		return $this->language->lang('CPF_AUTOGROUPS_TYPE_TEXT');
	}
	...
	public function get_users_for_condition($options = array())
	{
		...
		$sql_array['WHERE'] .= $this->functions->get_cpf_conditions('text');
