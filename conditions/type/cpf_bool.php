...
class cpf_bool extends base
{
	...
	*/
	...
	{
		return 'david63.cpfautogroup.autogroups.type.cpf_bool';
	}
	...
	*/
	...
	{
		$cpf_field = 'pf_' . $this->functions->cpf_data_get('cpf_field_name', 'bool');
			return $cpf_field;
		}
	...
	*/
	...
	{
		return $this->language->lang('CPF_AUTOGROUPS_TYPE_BOOLEAN');
	}
	...
	public function get_users_for_condition($options = array())
	{
		...
		$sql_array['WHERE'] .= $this->functions->get_cpf_conditions('bool');
	...
	protected function sql_where_clause($options)
	{
		...
		$cpf_field 		= 'pfd.pf_' . $this->functions->cpf_data_get('cpf_field_name', 'bool');
